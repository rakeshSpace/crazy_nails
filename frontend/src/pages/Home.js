                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                        {services.map(service => {
                            ...
                            const savings = getSavings(service.original_price, service.price);
                                        ...
                                        {service.image_url ? (
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    e.target.parentElement.innerHTML = '<div className="w-full h-full flex items-center justify-center"><i className="fas fa-spa text-5xl text-primary"></i></div>';
                                                }}
                                            />
                                        ) : (
                                                ...
                                                <>
                                                    ...
                                                    {savings > 0 && (
                                                        <div className="text-xs text-green-600 mt-1">
                                                            <i className="fas fa-save mr-1"></i> Save: ₹{savings}
                                                        </div>
                                                    )}
                                                </>
                                            ) : (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                        {[
                            ...
                            <div key={feature.number} className="bg-white dark:bg-dark rounded-2xl p-8 shadow-soft hover:shadow-medium transition-all hover:-translate-y-2 text-center">
                                <div className="text-4xl font-bold text-accent dark:bg-primary/30 mb-3">{feature.number}</div>
