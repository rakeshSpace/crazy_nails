                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white dark:bg-dark rounded-2xl shadow-soft overflow-hidden">
                                ...
                                {cartItems.map(item => {
                                    // Get image URL using the same function as Products.js
                                        ...
                                        <div key={item.id} className="border-t border-light-gray dark:border-gray-700 p-4">
                                            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                                                <div className="md:col-span-6 flex items-center gap-4">
                                                    <div className="w-16 h-16 bg-accent dark:bg-primary/20 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                                                        {imageUrl ? (
                                                            <img 
                                                                src={imageUrl} 
                                                                alt={item.name} 
                                                                ...
                                                                onError={(e) => {
                                                                    ...
                                                                    e.target.parentElement.innerHTML = '<i class="fas fa-spa text-2xl text-primary"></i>';
                                                                }}
                                                            />
                                                        ) : (
